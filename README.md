...
*(Real-word accuracy is expectedly lower than non-word accuracy because real-word correction requires contextual disambiguation against sparse bigram evidence in a 1M-token corpus, whereas non-word correction benefits from global unigram popularity.)*
